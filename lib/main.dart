...
/// Práctica Guiada 2 Asicronía en Flutter
...
// Se define el título
const String _title = 'Llamada asíncrona en flutter';
...
// Se define la clase _MyStateAppAsync
class _MyStateAppAsync extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: _title,
      home: Scaffold(
        appBar: AppBar(title: Text(_title), backgroundColor: Colors.pink.shade200),
        ...
        body: FractionallySizedBox(
          ...
          child: Column(
            ...
            children: [
              const Text("Por favor, presione los íconos:",
                  style:
